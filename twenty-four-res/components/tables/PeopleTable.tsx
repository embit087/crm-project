        ...
        <tbody>
          {people.map((person, index) => (
            ...
            >
              ...
              <td style={{ width: columnWidths.email }} className="text-text-muted">
                {person.email || "Email"}
              </td>
              ...
              <td style={{ width: columnWidths.company }}>
                {person.company ? (
              ...
              <td style={{ width: columnWidths.phones }} className="text-text-secondary">
